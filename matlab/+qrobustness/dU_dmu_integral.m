...
%DU_DMU_INTEGRAL Gauss-Legendre approximation of the segment derivative.
%   dU = DU_DMU_INTEGRAL(H, dH, dt, nodes, weights) approximates
%
...
%
%   Peer of python/src/qrobustness/core.py (dU_dmu with method='quadrature').
