...
%
%   G^(k)_ij = Re Tr(A_i^(k)' A_j^(k)).  Traceless grams build the joint
%   Lipschitz gauge C_joint; traceless normalised grams build the
%   Choi-angular and trajectory gauges (the exact Choi speed).  Raw grams
%   are retained for callers that need the uncentred Frobenius geometry.
%
