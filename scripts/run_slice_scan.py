...
from qrobustness.core import gate_fidelity, lipschitz_constant, propagator
...
#: Angles at which the two radial free-region boundaries are evaluated:
#: 256 intervals round the circle plus the closing point, so the curve
#: joins up when plotted.
N_THETA = 257


def main() -> None:
    """Scan the (mu_1, mu_2) plane and record the nested free regions."""
