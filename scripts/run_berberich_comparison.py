...
#: Seed strides keeping every (controller, structure, refinement) attack on
#: its own random stream: 300 per controller covers 3 structures x 100, and
...
def main() -> None:
    """Tabulate the Berberich margins, optionally attacking the first N."""
