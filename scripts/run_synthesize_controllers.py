...
def main() -> None:
    """Synthesise the ensemble and record it with its provenance."""
    ...
    meta = {
        ...
        # The key spells the threshold, and the MATLAB peer writes the same
        # name, so the two would have to move together; the value it counts
