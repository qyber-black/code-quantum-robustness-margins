        ...
        for g, q in enumerate(refinements):
            ...
            for b, fac in enumerate(BUDGET_FACTORS):
                ...
                Fmin, delta = adversarial_fidelity(
                    ...
                    n_starts=n_starts,
                    maxiter=maxiter,
                    # Collision-free stride: structures x grids x budgets.
                    seed=seed
                    + len(STRUCTURES) * 100 * i
                    + 100 * STRUCTURES.index(tag)
                    + 10 * g
                    + b,
                    starts=starts,
                )
                ...
                if fac == 1.0 and Fmin < ft - 1e-10:
                    ...
                    dH_traj = [dk * Hk for dk, Hk in zip(delta, Hhatg)]
